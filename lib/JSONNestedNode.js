...
var JSONNestedNode = (function(_React$Component) {
  ...
  JSONNestedNode.prototype.componentWillReceiveProps = function componentWillReceiveProps(
    nextProps
  ) {
  ...
  JSONNestedNode.prototype.shouldComponentUpdate = function shouldComponentUpdate(
    nextProps,
    nextState
  ) {
    var _this2 = this;
  ...
  JSONNestedNode.prototype.render = function render() {
    ...
    console.log('rendered JSONNestedNode with', { stylingArgs: stylingArgs });
    ...
    return hideRoot
      ...
      : _react2['default'].createElement(
          ...
          _react2['default'].createElement(
            'span',
            styling.apply(undefined, ['renderedIcon'].concat(stylingArgs)),
            iconRenderer.apply(undefined, stylingArgs)
          ),
          _react2['default'].createElement(
            'ul',
            styling.apply(
