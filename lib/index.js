...
var emptyRenderer = function emptyRenderer(value) {
  return null;
  ...
  return {
    styling: function styling() {
      if (props.styleOverrides && props.styleOverrides[arguments[0]]) {
        var _props$styleOverrides;

        return (_props$styleOverrides = props.styleOverrides)[
          arguments[0]
        ].apply(_props$styleOverrides, arguments);
      }
      return (0, _createStylingFromTheme2['default'])(theme).apply(
        undefined,
        arguments
      );
    }
...
var JSONTree = (function(_React$Component) {
  ...
  JSONTree.prototype.componentWillReceiveProps = function componentWillReceiveProps(
    nextProps
  ) {
    var _this2 = this;

    if (
      ['styleOverrides', 'theme', 'invertTheme'].find(function(k) {
